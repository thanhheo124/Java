...
public class BanCo {
	...
	public static final int DO_RONG_O_VUONG = 50;
	...
	public void kiemTraThangCuoc() {
		if (nguoiChoi1.getListQuanCo().size() + nguoiChoi2.getListQuanCo().size() < MIN_QUAN_CO_FOR_WIN) {
			return;
		}
		if (kiemTraThangCuoc(nguoiChoi1.getLoaiQuanCo())) {
			thongBaoThangCuoc(nguoiChoi1.getLoaiQuanCo());
		}
	...
	private boolean kiemTraThangCuoc(char loaiQuanCo) {
		List<QuanCo> tmpList = nguoiChoi1.getListQuanCo();
